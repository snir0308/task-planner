...
export default function Board({ readOnly = false, boardId }) {
    ...
    const loadData = async () => {
      if (boardId) {
        ...
        if (board) {
          ...
          setProfileImage(board.profileImage || "");
          setDisplayName(board.displayName || "");
          setPurposeStatement(board.purposeStatement || "");
          setLastBackup(board.lastBackup || null);
          setFavorites(board.favorites || []);
        }
      } else {
